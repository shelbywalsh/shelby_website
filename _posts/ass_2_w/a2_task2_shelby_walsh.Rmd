---
title: "Palmetto Species Logistic Regression Preditions"
author: "Shelby Walsh"
date: "2/9/2021"
output: 
  html_document:
...
palmetto_height <- ggplot(data = palmetto, aes(x = height, y = length)) +
  ...
  labs(x = "Height (cm)",
       y = "Length (cm)", 
       title = "Comparison of Canopy Height and Length of Two South-Central Florida\n Palmetto Species, Sabel etonia and Serenoa repens") +
...
palmetto_canopy <- ggplot(data = palmetto, aes(x = width, y = green_lvs)) +
  ...
  labs(x = "Width (cm)",
       y = "Green Leaf Count", 
       title = "Comparison of Canopy Width and Green Leaf Count of Two South-Central Florida\n Palmetto Species, Sabel etonia and Serenoa repens") +
  theme(legend.title = element_blank()) +
  theme(plot.title = element_text(size = 12,
                                   face = "bold",
        hjust = 0.5))
...
palmetto_hg <- ggplot(data = palmetto, aes(x = green_lvs, y = height)) +
  ...
  labs(x = "Green Leaf Count",
       y = "Height (cm)", 
       title = "Comparison of Height and Green Leaf Count of Two South-Central Florida\n Palmetto Species, Sabel etonia and Serenoa repens") +
  theme(legend.title = element_blank()) +
  theme(plot.title = element_text(size = 12,
                                   face = "bold",
        hjust = 0.5))
